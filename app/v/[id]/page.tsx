...
export default async function Video({ params }: PageProps) {
    ...
    const file = data.result[0];
        ...
        url: `https://toketbocil.pages.dev/v/${file.filecode}`,
        ...
        publisher: {
            '@type': 'Organization',
            name: `${SITENAME}`,
            logo: 'https://toketbocil.pages.dev/favicon.ico'},
            author: {
                '@type': 'Person',
                name: 'admin',
                url: 'https://toketbocil.pages.dev'
              },
        interactionStatistic: {
            ...
            interactionType: {
                '@type': `ReadAction`,
                target: `https://toketbocil.pages.dev/v/${file.filecode}`
            }  
        }
        }
        const jsonLd3 = {
